...
import com.hardik.springboot.web.springbootfirstwebapplication.service.TodoRepository;
import com.hardik.springboot.web.springbootfirstwebapplication.service.TodoService;
...
public class TodoController {
	...
	public String showTodos(ModelMap model) {
		...
		model.put("todos", todoRep.findByUser(name));
